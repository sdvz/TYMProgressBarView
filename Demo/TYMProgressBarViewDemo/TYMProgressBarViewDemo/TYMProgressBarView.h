...
/**
 It determines whether to show progress label.
 ...
 */
@property (nonatomic) NSInteger showLabel UI_APPEARANCE_SELECTOR;

/**
 The progress percentage label font
 
 
 The default is `bold system font of size 15.0`.
...
/**
 The progress percentage label text color
